...
namespace UnityEditor.PackageManager.ValidationSuite.Tests
{
    internal class ApiValidationTests
    {
        ...
        {
            var previousPackagePath = Path.GetFullPath(Path.Combine(testPackageRoot, previousPackageName));
            var projectPackagePath = Path.GetFullPath(Path.Combine(testPackageRoot, projectPackageName));
